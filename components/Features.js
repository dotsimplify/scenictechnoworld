    ...
    <section className="  flex flex-col items-center ">
      <div className="container lg:px-16  px-2  space-y-20 w-full   ">
        ...
        <div className="grid lg:gap-12 lg:grid-cols-2 lg:items-center ">
            ...
            <div className="mt-12 space-y-12">
              <div className="flex">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center w-12 h-12 rounded-md bg-sky-500 ">
                    <svg
          ...
          <div aria-hidden="true" className="mt-10 lg:mt-4  ">
            <img
              src="/images/google-hero.svg"
              alt=""
